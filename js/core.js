...
// SHALOM CRATE: national/pop-culture Israel theme, styled TEXT badges (art IS hardcoded CSS
// color/gradient work, same as Counterfinish -- not photo art, so no hideNameOnBadge anywhere in
// this array). Lives in Cosmetixxx (#shop-titles), this repo's default placement for new crates.
...
// `badgeText` is an optional per-title override read by titleBadgeMarkup() (js/market.js): when
// set, the small badge chip shows this short string instead of the full `name`, while `name` still
// shows everywhere else (Inventory, Trade, MTN, the "you won X" toast, hover popover, Showcase) --
// same non-badge surfaces hideNameOnBadge already lets through, just for a short label instead of
// nothing. Only shNetanyahu uses it.
const SHALOM_CRATE_COST = 3333;
const SHALOM_CRATE_TITLES = [
  // THE chase. Equip effect mirrors the RED/BLUE Presidential Rares' nameStyle mechanic (see
  // js/nameStyle.js) -- animated blue-white gradient name while equipped.
  { id: 'shNetanyahu', name: 'Animated Netanyahu', badgeText: 'NETANYAHU', cssClass: 'title-sh-netanyahu', weight: 0.5, rarity: 'mythic', how: 'Won from a SHALOM CRATE spin (mythic!). Recolors your name everywhere in an animated blue-white gradient while equipped.' },
  { id: 'shGalGadot', name: 'Gal Gadot', cssClass: 'title-sh-galgadot', weight: 2.5, rarity: 'rare', how: 'Won from a SHALOM CRATE spin (rare).' },
  { id: 'shGoldaMeir', name: 'Golda Meir', cssClass: 'title-sh-goldameir', weight: 4, rarity: 'rare', how: 'Won from a SHALOM CRATE spin (rare).' },
  { id: 'shIronDome', name: 'Iron Dome', cssClass: 'title-sh-irondome', weight: 5, rarity: 'rare', how: 'Won from a SHALOM CRATE spin (rare).' },
  ...
  { id: 'shKravMaga', name: 'Krav Maga', cssClass: 'title-sh-kravmaga', weight: 7, rarity: 'uncommon', how: 'Won from a SHALOM CRATE spin (uncommon).' },
  { id: 'shEurovision', name: 'Eurovision', cssClass: 'title-sh-eurovision', weight: 7, rarity: 'uncommon', how: 'Won from a SHALOM CRATE spin (uncommon).' },
  { id: 'shDeadSea', name: 'Dead Sea', cssClass: 'title-sh-deadsea', weight: 8, rarity: 'uncommon', how: 'Won from a SHALOM CRATE spin (uncommon).' },
  { id: 'shIsraelFlag', name: 'Israel Flag', cssClass: 'title-sh-israelflag', weight: 16, rarity: 'common', how: 'Won from a SHALOM CRATE spin (common).' },
  { id: 'shHummus', name: 'Hummus', cssClass: 'title-sh-hummus', weight: 16, rarity: 'common', how: 'Won from a SHALOM CRATE spin (common).' },
